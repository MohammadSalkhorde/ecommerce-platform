    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_name', models.ImageField(upload_to=utils.UploadFile.upload_to, verbose_name='تصویر برند')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, null=True)),
                ('brand', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brands', to='products.brand')),
            ],
            options={
                'verbose_name': 'کالا',
